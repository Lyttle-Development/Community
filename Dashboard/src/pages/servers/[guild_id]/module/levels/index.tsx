...
export function getLevelsConfig({
  ...
  return {
    ...
    route: `/servers/${guildId}/module/levels`,
    subItems: [
      {
        id: nicknameKey,
        route: `/servers/${guildId}/module/levels#nickname`,
      ...
      {
        id: announcementKey,
        route: `/servers/${guildId}/module/levels#announcement`,
      ...
      // {
      //   id: leaderboardKey,
      //   route: `/servers/${guildId}/module/levels#leaderboard`,
